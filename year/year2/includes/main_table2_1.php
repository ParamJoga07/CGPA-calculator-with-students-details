...
input[type="password"]:focus {
  ...
  transition: 0.2s ease;
			...
			<center>
				<form action="/login/students/result2_1.php" method="post">
                ...
                <input type="text4" name="s_enroll_no" placeholder="Student's Enrollment Number" />
					...
					<!--form method="post" action="/login/students/result2_1.php"-->
						<thead>
							<th>S/N</th>
							<th>COURSE CODE</th>
							<th>COURSE NAME</th>
  	...
  	background-image: linear-gradient(315deg, #2d3436 0%, #d3d3d3 74%);" class="form-control"></label>
						...
						<tr class="datarow">
								<td class="sn">1</td>
								<td><input type="text" name="course_code_1" placeholder="Enter the course Code" value="ES211"></td>
								<td><input type="text" name="course_name_1" placeholder="Enter the course name" value="Electrical Sciences I"></td>
							...
							<tr class="datarow">
								<td class="sn">2</td>
								<td><input type="text" name="course_code_2" placeholder="Enter the course Code" value="ES212">></td>
								<td><input type="text" name="course_name_2" placeholder="Enter the course name" value="Digital Electronics">></td>
							...
							<tr class="datarow">
								<td class="sn">3</td>
								<td><input type="text" name="course_code_3" placeholder="Enter the course Code" value="ES213"></td>
								<td><input type="text" name="course_name_3" placeholder="Enter the course name" value="Engineering Mechanics"></td>
							...
							<tr class="datarow">
								<td class="sn">4</td>
								<td><input type="text" name="course_code_4" placeholder="Enter the course Code" value="MATH215"></td>
								<td><input type="text" name="course_name_4" placeholder="Enter the course name" value="Complex Variables"></td>
							...
							<tr class="datarow">
								<td class="sn">5</td>
								<td><input type="text" name="course_code_5" placeholder="Enter the course Code" value="MATH216"></td>
								<td><input type="text" name="course_name_5" placeholder="Enter the course name" value="Differential Equations & Fourier Series"></td>
