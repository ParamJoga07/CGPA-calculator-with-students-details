...
session_start();
	...
	if(!empty($s_name) && !empty($s_enroll_no) && !empty($s_department) && !empty($s_year) && !empty($s_semester) && !empty($s_email_id) && !is_numeric($s_name))
	{
		...
		$query = "insert into students3_2 (s_name,s_enroll_no,s_department,s_year,s_semester,s_email_id) values ('$s_name','$s_enroll_no','$s_department','$s_year','$s_semester','$s_email_id')";
...
<body>
    ...
    <div class="left">
            ...
            <form action="/login/year/year3/sem2.php" method="post">
             <label class="labels">Name</label>
                ...
                <input type="text" name="s_year" placeholder="Student's Graduation Year" value="3"/>
        ...
        <div class="or">
          <a href="/login/year/year3/sem2.php"><input type="submit" value="SAVE & NEXT"></a><br><br>
        </div>
        </form>
      </div>
</body>
