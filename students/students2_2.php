...
session_start();
	...
	if(!empty($s_name) && !empty($s_enroll_no) && !empty($s_department) && !empty($s_year) && !empty($s_semester) && !empty($s_email_id) && !is_numeric($s_name))
	{
		...
		$query = "insert into students2_2 (s_name,s_enroll_no,s_department,s_year,s_semester,s_email_id) values ('$s_name','$s_enroll_no','$s_department','$s_year','$s_semester','$s_email_id')";
...
<body>
    ...
    <div class="left">
            ...
            <form action="/login/year/year2/sem2.php" method="post">
             <label class="labels">Name</label>
                ...
                <input type="text" name="s_year" placeholder="Student's Graduation Year" value="2"/>
            ...
            <input type="text" name="s_semester" placeholder="Student's Semester" value="2"/>
            <label class="labels">Email ID</label>
            <input type="text" name="s_email_id" placeholder="Student's Email ID"/><br>

        </div>
        <div class="or">
          <a href="/login/year/year2/sem2.php"><input type="submit" value="SAVE & NEXT"></a><br><br>
        </div>
        </form>
      </div>
</body>
