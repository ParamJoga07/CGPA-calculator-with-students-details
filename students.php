    ...
    <div class="left">
            ...
            <form action="index.php" method="post">
             <label class="labels">Name</label>
                ...
                <input type="text" name="s_year" placeholder="Student's Graduation Year"/>
            ...
            <input type="text" name="s_semester" placeholder="Student's Semester"/>
            <label class="labels">Email ID</label>
            <input type="text" name="s_email_id" placeholder="Student's Email ID"/><br>

        </div>
        <div class="or">
          <a href="index.php"><input type="submit" value="SAVE & NEXT"></a><br><br>
        </div>
        </form>
      </div>
</body>
